(function (exports, $) {
	...
	exports.TeambuilderRoom = exports.Room.extend({
		...
		renderSet: function (set, i) {
			...
			var isNatDex = this.curTeam.format.includes('nationaldex') || this.curTeam.format.includes('natdex') || this.curTeam.format.includes('modded') || this.curTeam.format.includes('poa') || this.curTeam.format.includes('altermons') || this.curTeam.format.includes('hellskitchen') || this.curTeam.format.includes('buildmons');
